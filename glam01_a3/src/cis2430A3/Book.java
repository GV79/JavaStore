 ...
 * @author Giavinh
 */
public class Book extends Product { // Child class of Product
	 ...
	 */
	public String setAuthor(String input) // Mutator Methods (set a variable)
	{
		authors = input;
		return authors;
	}
	 ...
	 * @return Returns object's publisher (type String)
	 */
	public String getPublisher()// Accessor Methods (get a variable)
	{
		return publisher;
	}
